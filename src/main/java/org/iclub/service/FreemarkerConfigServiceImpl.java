...
public class FreemarkerConfigServiceImpl implements FreemarkerConfigService {
    ...
    public void refresh() {
        ...
        try {
            configuration.setSharedVariable(SettingService.TITLE,
                    getValue(settingService.findSettingByName(SettingService.TITLE)));
            configuration.setSharedVariable(SettingService.DESCRIPTION,
                    getValue(settingService.findSettingByName(SettingService.DESCRIPTION)));
            configuration.setSharedVariable(SettingService.TWITTER,
                    getValue(settingService.findSettingByName(SettingService.TWITTER)));
            configuration.setSharedVariable(SettingService.FACEBOOK,
                    getValue(settingService.findSettingByName(SettingService.FACEBOOK)));
            configuration.setSharedVariable(SettingService.PINTEREST,
                    getValue(settingService.findSettingByName(SettingService.PINTEREST)));
            configuration.setSharedVariable(SettingService.YOUTUBE,
            ...
            configuration.setSharedVariable(SettingService.CONTACT_ADDRESS_LINE1,
                    getValue(settingService.findSettingByName(SettingService.CONTACT_ADDRESS_LINE1)));
            configuration.setSharedVariable(SettingService.CONTACT_ADDRESS_LINE2,
                    getValue(settingService.findSettingByName(SettingService.CONTACT_ADDRESS_LINE2)));
            configuration.setSharedVariable(SettingService.CONTACT_CITY,
                    getValue(settingService.findSettingByName(SettingService.CONTACT_CITY)));
            configuration.setSharedVariable(SettingService.CONTACT_STATE,
                    getValue(settingService.findSettingByName(SettingService.CONTACT_STATE)));
            configuration.setSharedVariable(SettingService.CONTACT_ZIP_CODE,
                    getValue(settingService.findSettingByName(SettingService.CONTACT_ZIP_CODE)));
            configuration.setSharedVariable(SettingService.CONTACT_PHONE,
                    getValue(settingService.findSettingByName(SettingService.CONTACT_PHONE)));
